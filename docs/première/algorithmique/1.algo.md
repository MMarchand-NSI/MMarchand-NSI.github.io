...
!!! question "Ensembe des minimisants"
...
Ici, voici un programme écrit en Why3 version 1.8.0 qui permet de prouver la correction totale de l'algorithme argmin à l'aide du prover alt-ergo version 2.6.0
