...
!!! note "Rappel d'ouverture (5 minutes, cours fermé)"
    On répond **sans rouvrir** la page sur la recherche dichotomique.

    1. Énoncer en une phrase le principe de la recherche dichotomique, et la condition **indispensable** pour pouvoir l'appliquer.
    2. Quelle est sa complexité ? Que se passe-t-il si on double la taille du tableau ?
    3. Qu'est-ce qui garantit que l'algorithme s'arrête ?

    ??? success "Corrigé"
        1. On compare la valeur cherchée à l'élément du milieu et on élimine la moitié du tableau à chaque étape. Condition indispensable : le tableau doit être **trié**.
        2. $\mathcal{O}(\log n)$, complexité logarithmique. Doubler la taille du tableau ne coûte **qu'une étape de plus**, alors qu'une recherche séquentielle demanderait deux fois plus de comparaisons.
        3. La **taille de la zone de recherche**, qui diminue de moitié à chaque tour et finit donc par être vide. C'est cette quantité qui décroît qui garantit la terminaison.
