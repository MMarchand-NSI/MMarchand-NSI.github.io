...
!!! question "La base 1"
    ...
    On va maintenant killer le processus. Entrez la combinaison de touches <kbd>Ctrl+C</kbd>. Cette combinaison envoie un signal SIGINT (interruption) au processus en avant plan, qui met fin à son exécution.
